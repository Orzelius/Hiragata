...
const Navbar: React.FC = () => (
  <nav className="flex bg-white fixed top-0 inset-x-0 z-100 h-16 items-center">
    <div className="w-full max-w-screen-xl relative mx-auto px-6 container">
      <div className="flex items-center -mx-6 border-b-2 border-gray-200">
        <div className="p-2 sm:pl-8">
          <div className="flex items-center">
            <Link to="/" className="block mt-1 w-max">
        ...
        <div className="flex flex-grow lg:w-3/4 xl:w-4/5">
          ...
          <div className="p-2 sm:pr-8 flex items-center justify-between">
            <div className="flex justify-start items-center text-gray-500">
              <a className="block items-center hover:text-gray-700 mr-5 text-lg" target="_blank" rel="noreferrer" href="https://test-ai.hiragata.com/" title="Play with the AI here">
                AI
              </a>
              <a className="block items-center hover:text-gray-700 mr-5" href="https://twitter.com/orzelius" target="_blank" rel="noreferrer">
              ...
              <a className="block items-center hover:text-gray-700 mr-5" target="_blank" rel="noreferrer" href="https://github.com/Orzelius/Hiragata">
                <svg className="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  <title>GitHub</title>
                  <path d="M10 0a10 10 0 0 0-3.16 19.49c.5.1.68-.22.68-.48l-.01-1.7c-2.78.6-3.37-1.34-3.37-1.34-.46-1.16-1.11-1.47-1.11-1.47-.9-.62.07-.6.07-.6 1 .07 1.53 1.03 1.53 1.03.9 1.52 2.34 1.08 2.91.83.1-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.94 0-1.1.39-1.99 1.03-2.69a3.6 3.6 0 0 1 .1-2.64s.84-.27 2.75 1.02a9.58 9.58 0 0 1 5 0c1.91-1.3 2.75-1.02 2.75-1.02.55 1.37.2 2.4.1 2.64.64.7 1.03 1.6 1.03 2.69 0 3.84-2.34 4.68-4.57 4.93.36.31.68.92.68 1.85l-.01 2.75c0 .26.18.58.69.48A10 10 0 0 0 10 0" />
                </svg>
              </a>
              {/* <a className="block items-center hover:text-gray-700" href="/discord">
