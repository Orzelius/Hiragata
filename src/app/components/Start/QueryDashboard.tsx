    ...
    case (0):
      ...
      question.answers = (
        <div className="justify-center mt-8 sm:flex">
          <AnswerBox onClick={() => { answer("hiragana") }} text="hiragana" title="ひ"></AnswerBox>
          <AnswerBox onClick={() => { answer("katakana") }} text="katakana" title="カ"></AnswerBox>
          <AnswerBox onClick={() => { answer("both") }} text="both" title="ひか"></AnswerBox>
        </div>
      )
      break;
    case (1):
      ...
      question.answers = (
        <div>
          ...
          <div className="justify-center mt-8 sm:flex">
            <CheckBox onClick={() => { answer("hiragana") }} text="hiragana" title="ひ"></CheckBox>
            <CheckBox onClick={() => { answer("katakana") }} text="katakana" title="カ"></CheckBox>
            <CheckBox onClick={() => { answer("romanji") }} text="romanji" title="Ro"></CheckBox>
          </div>
