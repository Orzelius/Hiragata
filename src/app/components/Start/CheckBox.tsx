...
const CheckBox: React.FC<checkProps> = ({ title, text, onClick }) => {
  ...
  if(!checked){
    return (
      <div onClick={() => {onClick(), onLocalClick()}}
        ...
        <div style={{top: "-5px"}} className=" relative inline-block content-center pb-2 sm:block sm:mt-4">
          <h1 className="text-2xl text-gray-800 sm:text-center ml-2 sm:ml-0">{text}</h1>
        </div>
      </div>
    )
  }
  if(checked){
    return (
      <div onClick={() => {onClick(), onLocalClick()}}
        ...
        <div style={{top: "-5px"}} className=" relative inline-block content-center pb-2 sm:block sm:mt-4">
          <h1 className="text-2xl text-blue-600 sm:text-center ml-2 sm:ml-0">{text}</h1>
        </div>
      </div>
    )
  }
